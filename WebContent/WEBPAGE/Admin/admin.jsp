	...
	<script>
		$(function(){
			...
			$('.snip1535.my1').mouseover(function(){
				$('#my1').attr('src', '../_img/adminimg1-hover.png');
			});
			$('.snip1535.my1').mouseout(function(){
				$('#my1').attr('src', '../_img/adminimg1.png');
			});
			
			//2
			$('.snip1535.my2').mouseover(function(){
				$('#my2').attr('src', '../_img/adminimg2-hover.png');
			});
			$('.snip1535.my2').mouseout(function(){
				$('#my2').attr('src', '../_img/adminimg2.png');
			});
			
			//3
			$('.snip1535.my3').mouseover(function(){
				$('#my3').attr('src', '../_img/adminimg3-hover.png');
			});
			$('.snip1535.my3').mouseout(function(){
				$('#my3').attr('src', '../_img/adminimg3.png');
			});
...
<body>
	...
	<div class="wrap_1920">
		<div class="subVisual">
			<div class="subVisual_wrap">
				<div class="sub_txt">
					<div class="sub_title">관리자페이지</div>
					<div class="sub_exp">Adminpage</div>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="wrap_1200">
        ...
        <div class="page">
            <div class="page_menu">
                <div class="tr">
                    <a href="Product/productList.jsp"><button class="snip1535 my1"><img src="../_img/adminimg1.png" id="my1"></button></a>
                    <a href="memberList.jsp"><button class="snip1535 my2"><img src="../_img/adminimg2.png" id="my2"></button></a>
                    <a href="orderedList.jsp"><button class="snip1535 my3"><img src="../_img/adminimg3.png" id="my3"></button></a>
                </div>
                <div class="tr">

	...
	<div class="wrap_1200">
        <div class="member_list">
            ...
            <table class="member_field">
                <tr class="imgfile">
                    <td>이미지1</td>
                    <td><input type="file" name="PDR_image"></td>
                </tr>
                <tr class="imgfile">
                    <td>이미지2</td>
                ...
                <tr class="prod_info">
                    <td>수량</td>
                    <td><input type="text" name="count"> 개</td>
                </tr>
                <tr class="prod_info">
                    <td>분류</td>
                    <td>
                ...
                <tr class="prod_exp">
                    <td>판매일</td>
                    <td class="publishing"><select name="publishing_year">
        ...
        <%} %>
            ...
            <div class="reg_prod_btn">
                <div class="prod_list"><a href="productList.jsp"><img src="../../_img/reg-prod-list.png"></a></div>
                <div class="reg_reg">

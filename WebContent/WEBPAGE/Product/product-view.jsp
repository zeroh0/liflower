...
<body>
	...
	<div class="wrap_1200">
		<div class="view_field">
            <div class="row">
                <div class="view_img">
                    <div class="title_img"><img src="../_img/view_test_img.jpg" alt="상품이미지1"></div>
                ...
                <div class="view_txt">
                          ...
                          <tr>
                              ...
                              <td>
                                  <div class="amount_box">
                                      <div class="minus"><a><img src="../_img/minus.png" alt="마이너스" style="vertical-align: middle"></a></div>
                                      <div class="input_number">
                                          <input type=hidden name="sell_price" value="5500">
                                          <input type="text" name="amount" value="1" onchange="change();">
                                      </div>
                                      <div class="plus"><a><img src="../_img/plus.png" alt="플러스" style="vertical-align: middle"></a></div>
                                  </div>
                              </td>
                              <td>9,900원</td>
                          </tr>
                    ...
                    <div class="total">
                        <table>
                            <tr>
                                <td>총 합계금액</td>
                                <td><span>12,400</span>원</td>
                            </tr>
                        </table>
                    </div>
                    <div class="view_btn">
                        <div class="basket"><a href="#"><img src="../_img/basket_btn.png" alt="장바구니"></a></div>
